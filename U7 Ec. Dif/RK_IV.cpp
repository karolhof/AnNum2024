...
void rungeKutta() {
    ...
    for (int i = 0; i <= steps; i++) {
        ...
        cout << setw(5) << i << " | "
             ...
             << setw(15) << fixed << setprecision(5) << k4 << " | ";


        // Calcular el nuevo valor de y
        y = y + ((k1 + 4 * k2 + k3+ k4) / 6)*h; // Actualiza y utilizando la combinación de k1, k2, k3
...
int main() {
    ...
    cout << string(60, '-') << endl;
    cout << "Método de Runge-Kutta de cuarto orden" << endl;
    cout << string(60, '-') << endl;
